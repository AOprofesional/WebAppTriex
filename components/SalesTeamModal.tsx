...
import { useSalesTeam, SalesTeamMember } from '../hooks/useSalesTeam';
...
export const SalesTeamModal: React.FC<SalesTeamModalProps> = ({ isOpen, onClose, coordinatorPhone }) => {
  const { team, loading } = useSalesTeam();

  if (!isOpen) return null;

  const handleWhatsApp = (agent: SalesTeamMember) => {
        ...
        <div className="p-6 overflow-y-auto hide-scrollbar">
          {loading ? (
            ...
            <div className="text-center py-8 text-zinc-500">
              No hay equipo de ventas disponible.
            </div>
          ) : (
                ...
                >
                  <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-white dark:border-zinc-700 shadow-md">
                    {agent.image_url ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-zinc-200 dark:bg-zinc-700 text-zinc-400">
